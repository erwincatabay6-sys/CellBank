...
function DashboardAttentionRepairs({ repairs, onRepairClick }) {
  if (repairs.length === 0) {
    return (
      <div className="workspace-empty-state">
        <strong>No repairs need attention</strong>

        <p>There are currently no repair jobs requiring immediate follow-up.</p>
      </div>
    );
  }
