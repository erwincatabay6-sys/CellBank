function RepairOverview({ repair, estimatedCost, agreedPrice }) {
  return (
    <section className="page-content repair-overview">
      ...
      <div className="repair-overview-grid">
        ...
        <div>
          ...
          <strong>{repair.accessoriesReceived ?? "None recorded"}</strong>
        </div>
        ...
        <div className="overview-wide">
          ...
          <strong>{repair.intakeNotes ?? "None recorded"}</strong>
        </div>
      </div>
    </section>
  );
